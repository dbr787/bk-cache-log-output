...
func printVerboseRestoreExample() {
    steps := []string{
        ...
        "  💨 \033[33;1mCache miss\033[0m for key [1/3]: dist-linux-x86_64-a3c91e04d629",
        "  🔍 Searching for key [2/3]: dist-linux-x86_64-feature/update-search-filter-ui",
        "  💨 \033[33;1mCache miss\033[0m for key [2/3]: dist-linux-x86_64-feature/update-search-filter-ui",
        "  🔍 Searching for key [3/3]: dist-linux-x86_64-main",
        "  🎯 \033[32;1mCache hit\033[0m for key [3/3]: dist-linux-x86_64-main",
    ...
    summary := []string{
        "",
        "\033[32m╭ Cache Restore Summary ────────────────────────────╮\033[0m",
        "\033[32m│\033[0m ID:            dist                               \033[32m│\033[0m",
        "\033[32m│\033[0m Registry:      default                            \033[32m│\033[0m",
        "\033[32m│\033[0m Result:        Hit [3/3] (fallback)               \033[32m│\033[0m",
        "\033[32m│\033[0m Key:           dist-linux-x86_64-main             \033[32m│\033[0m",
        "\033[32m│\033[0m Paths:         dist                               \033[32m│\033[0m",
        "\033[32m│\033[0m                .next/cache                        \033[32m│\033[0m",
        "\033[32m│\033[0m Download:      450 MB in 3.8 s                    \033[32m│\033[0m",
        "\033[32m│\033[0m Transfer:      118 MB/s                           \033[32m│\033[0m",
